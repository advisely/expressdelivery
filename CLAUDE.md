...
- **Phase 18 (planned):** Code signing (SignPath.io free for OSS), broader integration tests, macOS CI build job, Windows/Linux ARM64 coverage, sidebar reauth badge E2E seed hook
