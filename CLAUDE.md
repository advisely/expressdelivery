...
| `src/components/SettingsModal.tsx`| Two-level settings: horizontal categories (General/Email/AI/Data/System) + vertical sub-tabs, lazy Radix Tabs, Import/Export + About tabs |
...
- **Phase 16 (planned):** Code signing (SignPath.io free for OSS), E2E tests (Playwright), integration tests, macOS CI build job, Windows/Linux ARM64 coverage
